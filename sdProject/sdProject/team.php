   ...
   <div class="container">
   	 ...
   	 <div class="row">
         <div class="col-sm-12 col-md-6">
         	<div class = profile>
         		<img src="images/mubina.jpg"/>
         		<h3 class="user-name">Mubina Ashrafi</h3>
         		 <h5>18-01-04-030</h5>
                <h5>3rd Year Student</h5>
                <p>Department of Computer Science Ahsanullah University of Science and Technology</p>
         	</div>

         </div>
         <div class="col-sm-12 col-md-6">
         	<div class = profile>
         		<img src="images/sadia.jpg" />
         		<h3 class="user-name">Sadia Nawsin</h3>
         		<h5>18-01-04-049</h5>
                <h5>3rd Year Student</h5>
                <p>Department of Computer Science Ahsanullah University of Science and Technology</p>
         	</div>
